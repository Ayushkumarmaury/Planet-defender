...
class Enemy {
    ...
    update() {
        if (!this.free) {
            ...
            //check colllosion enemy/planet
            if (this.game.ckeckCollision(this, this.game.planet) && this.lives >=1) {
                this.lives = 0;
                this.speedX = 0;
                this.speedY = 0;
                this.collided = true;
            ...
            //check colllosion enemy/player
            if (this.game.ckeckCollision(this, this.game.player) && this.lives >=1) {
                this.lives = 0;
                this.collided = true;
                this.game.lives --;
            }
            ...
            this.game.projectilePool.forEach(projectile => {
                if (!projectile.free && this.game.ckeckCollision(this, projectile) && this.lives >= 1) {
                    projectile.reset();
                    this.hit(1);
                }
            });
...
class Game {
    ...
    drawStatusText(context) {
        ...
        context.fillText('Score :  ' + this.score, 18, 80);
        for(let i=0; i< this.lives; i++) {
            context.fillRect(20 + 15 * i, 110 ,80, 30);
        }
